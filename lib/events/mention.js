...
export async function handler(bot, message) {
  ...
  initialPrompt += 'You are here to help people with their questions and participate in interesting discussions. ' +
    ...
    `The last ${priorContext} messages in this channel have been provided for your context, with the sender's name preceding the message. Do not precede your response with your own name.`;
